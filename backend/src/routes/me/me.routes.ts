...
import { getMe, updateMe, exportMe } from "../../controllers/me/me.controller";
...
router.delete("/", authenticate, async (req, res) => {
	...
	const { deleteMe } = await import("../../controllers/me/me.controller");
...
router.get("/workouts", authenticate, async (req, res) => {
	...
	const workouts = await (await import("../../services/workout/workout.service")).getWorkoutsForUser(userId);
